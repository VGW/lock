    ...
    if (this.isUniversalLogin && ulpTelemetry) {
      ...
      telemetry = _extends({}, ulpTelemetry, {
        env: _extends(
          ...
          ulpTelemetry.env,
          ((_extends2 = {}),
          (_extends2['lock.js-ulp'] = (0, _helper.getVersion)()),
          (_extends2['auth0.js-ulp'] = _auth0Js2.default.version.raw),
          _extends2)
        )
      });
    }
    ...
    if (!this.isUniversalLogin && telemetryOverride) {
      ...
      telemetry = _extends({}, telemetryOverride, {
        env: _extends(
          ...
          ((_extends3 = {}),
          (_extends3['lock.js'] = (0, _helper.getVersion)()),
          (_extends3['auth0.js'] = _auth0Js2.default.version.raw),
          _extends3)
        )
      });
    }
