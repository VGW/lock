...
var Auth0APIClient = (function() {
  function Auth0APIClient(lockID, clientID, domain, opts) {
    ...
    var default_telemetry = ulpTelemetry
      ? _extends({}, ulpTelemetry, {
          env: _extends(
            {},
            ulpTelemetry.env,
            ((_extends2 = {}),
            (_extends2[lockTelemetryName] = '11.16.0'),
            (_extends2[auth0jsTelemetryName] = _auth0Js2.default.version.raw),
            _extends2)
          )
        })
      : {
